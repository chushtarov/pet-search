      ...
      <div className="flex w-[1260px] justify-between m-auto"> 
        <div className="flex items-center w-[600px] h-[243px] px-[25px] bg-stone-100 rounded-lg">
          ...
          <div className="w-[50%] ml-14">
            ...
            <button className="w-[100%] uppercase h-[40px] mt-3 text-white bg-[#f9961e] rounded-full text-sm hover:bg-[#fff] hover:text-[#f9961e] hover:border-orange-400 hover:border">Создать объявление</button>
          </div>
        </div>
