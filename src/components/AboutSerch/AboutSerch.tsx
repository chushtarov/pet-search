  ...
  return (
    <div className="w-[1200px] m-auto h-[286px] bg-slate-100 my-12 px-[40px] py-[15px]">
        ...
        <div className='flex justify-between'>
            <img src={left} alt="" />
            <button className="mt-10 w-[173px] uppercase h-[50px] text-white bg-[#f9961e] rounded-full text-sm hover:bg-[#fff] hover:text-[#f9961e] hover:border-orange-400 hover:border"><NavLink to='/serch'>Искать по фото</NavLink></button>
